          ...
          <View style={styles.memberBlock}>
              ...
              <View style={styles.memberAlertTextBlock}>
                <View style={styles.memberAlertTextWrap}>
                  <Text style={styles.memberAlertText}>忘记密码？</Text>  
                </View>
                <View style={styles.memberAlertTextWrap}>
                  <Text style={styles.memberAlertText}>没有账号，立即</Text>
                  <Text onPress={()=>{this.props.navigation.navigate('Regist')}} style={{color:'#3385ff',fontSize: 12}}>注册</Text>
                </View>
              </View>
          </View>
      </View>
